...
cons_anual <- list(
  consistencia_data_subs("DATA_SOLIC", "DATA_GERACAO",
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("DT_NASCIMENTO", "DATA_SOLIC",  
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("DT_NASCIMENTO", "DATA_GERACAO",  
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("DT_NASCIMENTO", "DATA_INICIO",  
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("DT_NASCIMENTO", "DATA_FIM",  
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("DT_NASCIMENTO", "DATA_OCORR",  
                         referencia_subs, "ANO", parametros_database),
  consistencia_data_subs("MOVIMENTACAO", "COMPETENCIA",  
                         referencia_subs, "ANO", parametros_database))
...
testes_cons <- data.frame("teste" = c("T1", "T2", "T3", "T4", "T5","T6","T7"),
...
"A data de competência não pode ser menor que a data de movimentação"))
